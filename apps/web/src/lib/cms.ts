...
const HOMEPAGE_CONNECT_FALLBACK: HomepageConnectContent = {
  ...
  rules: [
    ...
    "Humans create personal API tokens after sign-in via API-tokens under Pagina's in the project left menu.",
